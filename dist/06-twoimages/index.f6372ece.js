...
})({"drvyb":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "cc1d913ff6372ece";
"use strict";
...
},{}],"kXkck":[function(require,module,exports) {
...
},{"three":"ktPTu","../basics/setup.js":"6QXak","./frag.glsl":"3GTZG","./vert.glsl":"krdoX","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6QXak":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function createComposer(renderer, scene, camera) {
    let composer = new (0, _effectComposer.EffectComposer)(renderer);
    let renderPass = new (0, _renderPass.RenderPass)(scene, camera);
    composer.addPass(renderPass);
    return composer;
}
function createShaderPass(effect, composer) {
    let customPass = new (0, _shaderPass.ShaderPass)(effect);
...
},{"three":"ktPTu","three/examples/jsm/postprocessing/EffectComposer":"e5jie","three/examples/jsm/postprocessing/RenderPass":"hXnUO","three/examples/jsm/postprocessing/ShaderPass":"5IxTN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"e5jie":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"three":"ktPTu","../postprocessing/Pass.js":"i2IfB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3GTZG":[function(require,module,exports) {
...
},{}],"krdoX":[function(require,module,exports) {
module.exports = "precision mediump float;\n#define GLSLIFY 1\nvarying vec2 v_uv;\nuniform vec2 u_mouse;\nuniform vec2 u_res;\n\nvoid main() {\n    v_uv = uv;\n\n    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);\n}";

},{}]},["drvyb","kXkck"], "kXkck", "parcelRequireb594")

//# sourceMappingURL=index.f6372ece.js.map
