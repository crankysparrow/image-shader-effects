...
})({"9DtES":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "e4f1924605696086";
"use strict";
...
},{}],"JxWRm":[function(require,module,exports) {
...
let camera = new _three.OrthographicCamera(rect.width / -2, rect.width / 2, rect.height / 2, rect.height / -2);
...
let uniforms = {
    ...
    u_res: {
        value: new _three.Vector2(rect.width, rect.height)
    },
    u_mouse: {
        type: "v2",
...
let image = loader.load(theimage.src, ()=>{
    ...
    let geometry = new _three.PlaneBufferGeometry();
...
document.onmousemove = function(e) {
    if (e.target == renderer.domElement) {
        uniforms.u_mouse.value.x = (e.clientX - renderer.domElement.offsetLeft) / rect.width;
        uniforms.u_mouse.value.y = (e.clientY - renderer.domElement.offsetTop) / rect.height;
    } else {
...
},{"three":"ktPTu","./vert.glsl":"6EFLq","./frag.glsl":"2St0L","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6EFLq":[function(require,module,exports) {
module.exports = "#define GLSLIFY 1\nvarying vec2 v_uv;\nuniform vec2 u_mouse;\n\nvoid main() {\n    v_uv = uv;\n\n    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);\n}";

},{}],"2St0L":[function(require,module,exports) {
...
},{}]},["9DtES","JxWRm"], "JxWRm", "parcelRequireb594")

//# sourceMappingURL=index.05696086.js.map
